...
public class VoidCreator {
	...
	private static HashMap getIdentifiersOrg() {
		...
		identifiersOrg.put("http://dbName#AGD_GENE", "http://identifiers.org/agd/");
		identifiersOrg.put("http://dbName#AGD_TRANSCRIPT", "http://identifiers.org/agd/");
		...
		identifiersOrg.put("http://dbName#EC_NUMBER", "http://identifiers.org/ec-code/");
		identifiersOrg.put("http://dbName#EMBL", "http://identifiers.org/ena.embl/");
		...
		identifiersOrg.put("http://dbName#GO_to_gene", "http://identifiers.org/go/");
		identifiersOrg.put("http://dbName#GO_to_transcript", "http://identifiers.org/go/");
		identifiersOrg.put("http://dbName#GPCR", "http://identifiers.org/gpcrdb/");
		identifiersOrg.put("http://dbName#GeneDB", "http://identifiers.org/genedb/");
		identifiersOrg.put("http://dbName#Gramene_GenesDB", "http://identifiers.org/gramene.gene/");
		...
		identifiersOrg.put("http://dbName#IntEnz", "http://identifiers.org/ec-code/");
		...
		identifiersOrg.put("http://dbName#PBO", "http://identifiers.org/pombase/");
		identifiersOrg.put("http://dbName#PDB", "http://identifiers.org/pdb/");
		identifiersOrg.put("http://dbName#PDBsum", "http://identifiers.org/pdb/");
		...
		identifiersOrg.put("http://dbName#PIR", "http://identifiers.org/pirsf/");
		identifiersOrg.put("http://dbName#PO", "http://identifiers.org/obo.po/");
		identifiersOrg.put("http://dbName#PRF", "http://identifiers.org/ncbiprotein/");
		...
		identifiersOrg.put("http://dbName#SubtiList", "http://identifiers.org/subtilist/");
		identifiersOrg.put("http://dbName#Superfamily", "http://identifiers.org/supfam/");
		identifiersOrg.put("http://dbName#TAIR_LOCUS", "http://identifiers.org/tair.locus/");
		identifiersOrg.put("http://dbName#TAIR_LOCUS_MODEL", "http://identifiers.org/tair.locus/");
		identifiersOrg.put("http://dbName#TIGR", "http://identifiers.org/tigrfam/");
		identifiersOrg.put("http://dbName#TIGR_GeneIndex", "http://identifiers.org/tigrfam/");
		identifiersOrg.put("http://dbName#TIGR_ID", "http://identifiers.org/tigrfam/");
		identifiersOrg.put("http://dbName#TIGR_LOCUS", "http://identifiers.org/tigrfam/");
		identifiersOrg.put("http://dbName#TIGR_LOCUS_MODEL", "http://identifiers.org/tigrfam/");
		identifiersOrg.put("http://dbName#TIGR_TRANSCRIPT_ID", "http://identifiers.org/tigrfam/");
		...
		identifiersOrg.put("http://dbName#UniProtKB_all", "http://identifiers.org/uniprot/");
		...
		identifiersOrg.put("http://dbName#ZFIN_ID", "http://identifiers.org/zfin/");
		identifiersOrg.put("http://dbName#ZFIN_xpat", "http://identifiers.org/zfin.expression/");
		identifiersOrg.put("http://dbName#flybase_annotation_id", "http://identifiers.org/flybase/");
		identifiersOrg.put("http://dbName#flybase_gene_id", "http://identifiers.org/flybase/");
		identifiersOrg.put("http://dbName#flybase_polypeptide_id", "http://identifiers.org/flybase/");
		identifiersOrg.put("http://dbName#flybase_transcript_id", "http://identifiers.org/flybase/");
		identifiersOrg.put("http://dbName#flybase_translation_id", "http://identifiers.org/flybase/");
		...
		identifiersOrg.put("http://dbName#protein_id", "http://identifiers.org/insdc/");
		identifiersOrg.put("http://dbName#wormbase_id", "http://identifiers.org/wormbase/");	
